...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.xray.proxy.shadowsocks.ClientConfig result) {
      if (serverBuilder_ == null) {
    ...
    private void buildPartial0(com.xray.proxy.shadowsocks.ClientConfig result) {
