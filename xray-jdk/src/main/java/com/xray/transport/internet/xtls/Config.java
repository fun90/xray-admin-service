...
/**
 * Protobuf type {@code xray.transport.internet.xtls.Config}
 */
public  final class Config extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:xray.transport.internet.xtls.Config)
    ConfigOrBuilder {
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 18: {
            if (!((mutable_bitField0_ & 0x00000002) != 0)) {
              certificate_ = new java.util.ArrayList<com.xray.transport.internet.xtls.Certificate>();
              mutable_bitField0_ |= 0x00000002;
            }
            certificate_.add(
                input.readMessage(com.xray.transport.internet.xtls.Certificate.parser(), extensionRegistry));
            break;
          }
          case 26: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.xray.transport.internet.xtls.ConfigOuterClass.internal_static_xray_transport_internet_xtls_Config_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.xray.transport.internet.xtls.ConfigOuterClass.internal_static_xray_transport_internet_xtls_Config_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.xray.transport.internet.xtls.Config.class, com.xray.transport.internet.xtls.Config.Builder.class);
  }
  ...
  private java.util.List<com.xray.transport.internet.xtls.Certificate> certificate_;
  /**
   * <pre>
   ...
   */
  public java.util.List<com.xray.transport.internet.xtls.Certificate> getCertificateList() {
    return certificate_;
  }
  /**
   * <pre>
   ...
   * <code>repeated .xray.transport.internet.xtls.Certificate certificate = 2;</code>
   */
  public java.util.List<? extends com.xray.transport.internet.xtls.CertificateOrBuilder> 
   ...
   * <code>repeated .xray.transport.internet.xtls.Certificate certificate = 2;</code>
   */
  public com.xray.transport.internet.xtls.Certificate getCertificate(int index) {
   ...
   * <code>repeated .xray.transport.internet.xtls.Certificate certificate = 2;</code>
   */
  public com.xray.transport.internet.xtls.CertificateOrBuilder getCertificateOrBuilder(
      int index) {
    return certificate_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.xray.transport.internet.xtls.Config)) {
      return super.equals(obj);
    }
    com.xray.transport.internet.xtls.Config other = (com.xray.transport.internet.xtls.Config) obj;
  ...
  public static com.xray.transport.internet.xtls.Config parseFrom(
  ...
  public static com.xray.transport.internet.xtls.Config parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.xray.transport.internet.xtls.Config parseFrom(
  ...
  public static com.xray.transport.internet.xtls.Config parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.xray.transport.internet.xtls.Config parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static com.xray.transport.internet.xtls.Config parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.xray.transport.internet.xtls.Config prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:xray.transport.internet.xtls.Config)
      com.xray.transport.internet.xtls.ConfigOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.xray.transport.internet.xtls.ConfigOuterClass.internal_static_xray_transport_internet_xtls_Config_descriptor;
    }
    ...
    // Construct using com.xray.transport.internet.xtls.Config.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.xray.transport.internet.xtls.Config getDefaultInstanceForType() {
      return com.xray.transport.internet.xtls.Config.getDefaultInstance();
    }

    @java.lang.Override
    public com.xray.transport.internet.xtls.Config build() {
      com.xray.transport.internet.xtls.Config result = buildPartial();
    ...
    @java.lang.Override
    public com.xray.transport.internet.xtls.Config buildPartial() {
      com.xray.transport.internet.xtls.Config result = new com.xray.transport.internet.xtls.Config(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.xray.transport.internet.xtls.Config) {
        return mergeFrom((com.xray.transport.internet.xtls.Config)other);
      } else {
    ...
    public Builder mergeFrom(com.xray.transport.internet.xtls.Config other) {
      if (other == com.xray.transport.internet.xtls.Config.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.xray.transport.internet.xtls.Config parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.xray.transport.internet.xtls.Config) e.getUnfinishedMessage();
    ...
    private void ensureCertificateIsMutable() {
      if (!((bitField0_ & 0x00000002) != 0)) {
        certificate_ = new java.util.ArrayList<com.xray.transport.internet.xtls.Certificate>(certificate_);
        bitField0_ |= 0x00000002;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.xray.transport.internet.xtls.Certificate, com.xray.transport.internet.xtls.Certificate.Builder, com.xray.transport.internet.xtls.CertificateOrBuilder> certificateBuilder_;
    ...
    public Builder setCertificate(
        int index, com.xray.transport.internet.xtls.Certificate value) {
      if (certificateBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setCertificate(
        int index, com.xray.transport.internet.xtls.Certificate.Builder builderForValue) {
      if (certificateBuilder_ == null) {
        ensureCertificateIsMutable();
     ...
     * <code>repeated .xray.transport.internet.xtls.Certificate certificate = 2;</code>
     */
    public Builder addCertificate(com.xray.transport.internet.xtls.Certificate value) {
      if (certificateBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addCertificate(
        com.xray.transport.internet.xtls.Certificate.Builder builderForValue) {
      if (certificateBuilder_ == null) {
        ensureCertificateIsMutable();
    ...
    public Builder addAllCertificate(
        java.lang.Iterable<? extends com.xray.transport.internet.xtls.Certificate> values) {
      if (certificateBuilder_ == null) {
        ensureCertificateIsMutable();
     ...
     * <code>repeated .xray.transport.internet.xtls.Certificate certificate = 2;</code>
     */
    public com.xray.transport.internet.xtls.Certificate.Builder getCertificateBuilder(
        int index) {
     ...
     * <code>repeated .xray.transport.internet.xtls.Certificate certificate = 2;</code>
     */
    public com.xray.transport.internet.xtls.Certificate.Builder addCertificateBuilder() {
      return getCertificateFieldBuilder().addBuilder(
          com.xray.transport.internet.xtls.Certificate.getDefaultInstance());
    }
    /**
     * <pre>
     * List of certificates to be served on server.
    ...
    public com.xray.transport.internet.xtls.Certificate.Builder addCertificateBuilder(
        int index) {
      return getCertificateFieldBuilder().addBuilder(
          index, com.xray.transport.internet.xtls.Certificate.getDefaultInstance());
    }
    /**
     * <pre>
     * List of certificates to be served on server.
     ...
     * <code>repeated .xray.transport.internet.xtls.Certificate certificate = 2;</code>
     */
    public java.util.List<com.xray.transport.internet.xtls.Certificate.Builder> 
         getCertificateBuilderList() {
      return getCertificateFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.xray.transport.internet.xtls.Certificate, com.xray.transport.internet.xtls.Certificate.Builder, com.xray.transport.internet.xtls.CertificateOrBuilder> 
        getCertificateFieldBuilder() {
      if (certificateBuilder_ == null) {
  ...
  checkByteStringIsUtf8(value);
    ...
    // @@protoc_insertion_point(builder_scope:xray.transport.internet.xtls.Config)
  }

  // @@protoc_insertion_point(class_scope:xray.transport.internet.xtls.Config)
  private static final com.xray.transport.internet.xtls.Config DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.xray.transport.internet.xtls.Config();
  }

  public static com.xray.transport.internet.xtls.Config getDefaultInstance() {
